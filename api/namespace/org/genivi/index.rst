...
APIs defined by the `GENIVI alliance <https://www.genivi.org/>`_, mapped to XBR/WAMP.

Currently, the `Vehicle Signal Specification <https://github.com/GENIVI/vehicle_signal_specification>`_ is mapped in the namespace ``org.genivi.vss``:
